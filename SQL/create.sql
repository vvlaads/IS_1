CREATE TYPE MpaaRating AS ENUM ('PG_13', 'R', 'NC_17');
CREATE TYPE MovieGenre AS ENUM ('DRAMA', 'COMEDY', 'ADVENTURE', 'THRILLER', 'HORROR');
CREATE TYPE Color AS ENUM ('RED', 'BLACK', 'BROWN');
CREATE TYPE Country AS ENUM ('RUSSIA', 'USA', 'VATICAN', 'SOUTH_KOREA');
